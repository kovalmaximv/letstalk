...
public class ThinkService {
    ...
    @Autowired
    public ThinkService(ThinkRepo thinkRepo, WebSocketSender webSocketSender) {
    ...
    public ThinkPageDTO findAll(Pageable pageable) {
        Page<Think> page = thinkRepo.findAll(pageable);
